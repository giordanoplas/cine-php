            ...
            <main class="col">
                <div class="row">
                    <div class="columna col-lg-7">
                        <div class="widget">
                            <h3 class="titulo">Modificar Lugar</h3>
                            <form id="agregar-libro-form" method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">                                                            
                                ...
                                <div class="alert alert-warning text-center">
                                    <h4><strong><?php echo $lugar['nombre']; ?></strong></h4>
                                </div>
                                <input type="hidden" name="id" value="<?php echo $lugar['id']; ?>">	
                                <input type="text" name="nombre" id="nombre" placeholder="Nombre:" value="<?php echo $lugar['nombre']; ?>">                                                          
                                <hr>
                                ...
                                <input type="text" name="autocomplete" id="autocomplete" placeholder="Buscar Lugar:">
