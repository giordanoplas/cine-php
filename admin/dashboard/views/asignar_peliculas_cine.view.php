            ...
            <main class="col">
                <div class="row">
                    <div class="columna col-lg-7">
                        <div class="widget">
                            <h3 class="titulo">Asignar Película a Cine</h3>
                            <form id="agregar-libro-form" method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">                                                                                            
                                <div class="form-group">
                                    ...
                                    <select name="cines" id="cines" class="custom-select">
                                        <option value="0">N/A</option>
                                        <?php if(isset($cines) > 0): ?>                                                   
                                ...
                                <textarea name="horarios" placeholder="Horarios:"></textarea>
                                <hr>
                                ...
                                <div class="d-flex justify-content-center my-4">
                                    <button id="btnSubir" class="btn btn-primary py-2 px-4"><i class="fas fa-map-pin"></i> <b>Asignar</b></button>
                                </div>                                     
                            </form>
                        </div>
                    </div>
