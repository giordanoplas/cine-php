            ...
            <main class="main col">
                <div class="row">
                    <div class="columna col-lg-7">
                        ...
                        <h2 class="text-danger text-center shadow mb-4 p-2"><strong>GP Cine</strong></h2>    
                        <h4 class="text-justify">Mediante este panel, puedes administrar la web de GP Cine de forma dinámica y desde cualquier dispositivo.</h4>
                        ...
                        <div class="alert alert-success">
                            <strong>2.</strong> Debes haber recibido el entrenamiento previo para administrar los cines y carteleras.
                        </div>
